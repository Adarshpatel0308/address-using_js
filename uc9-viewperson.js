...
let citySearchResults = myAddressBook.viewContactsByCity("Bhopal");
console.log(citySearchResults);

// Search for contacts in a particular state
console.log("\nSearching for contacts in Madhya Pradesh...");
let stateSearchResults = myAddressBook.viewContactsByState("Madhya Pradesh");
console.log(stateSearchResults);
