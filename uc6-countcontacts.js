...
// Example contact creation and adding to address book
try {
...
// Get the number of contacts using reduce
const contactCount = myAddressBook.getNumberOfContacts();
console.log(`Number of contacts in the address book: ${contactCount}`);
